...
<div class="container">
  ...
  <div class="container" style="text-align:center;">
    ...
    <a href='astronaut_insert_db.php' type="button" class="btn btn-lg btn-default btn-success">ADD A NEW ASTRONAUT</a>
...
<!-- It displays a success message -->
  <div class="container">
  <h2 style="text-align:center;">NEW ASTRONAUT CREATED</h2>
  </div>
