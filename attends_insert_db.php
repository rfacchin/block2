      ...
      <div class="container">
        ...
        <div class="form-group">
          ...
          <form action="attends_insert_sucess_db.php" method="post"><b>Mission List:</b>
                      ...
                      <select name="attends_mission_name" class="form-control form-control-lg" aria-label=".form-select-lg example" Required>
                          ...
                          <?php
                            ...
                            echo "<option value=selected selected> -- Select a Mission -- </option>";
                            foreach ($rows as $row) {
                        ...
                        <b>Astronaut List:</b>
                        <select name="attends_astronaut_id" class="form-control form-control-lg" aria-label=".form-select-lg example" Required>
                          <?php
                            include 'connection.php';

                            $sqlGetastronaut = "SELECT * FROM astronaut";
                            $rows = $connection->query($sqlGetastronaut);
                            echo "<option value=selected selected> -- Select an Astronaut -- </option>";
                            foreach ($rows as $row) {
