...
<div class="container">
  ...
  <form action="" method="post">
    <div class="form-group">
      ...
      <input type="text" required class="form-control" name="mission_destination" placeholder="Destination" required>
    </div>
    
    <div class="form-group">
      <label for="mission_launch_date">Launch Date:</label>
      <input type="date" required class="form-control" name="mission_launch_date" placeholder="Launch Date" required>
    </div>
    
    <div class="form-group">
      <label for="mission_type">Mission Type:</label>
      <input type="text" required class="form-control" name="mission_type" placeholder="Mission Type" required>
    </div>

    <div class="form-group">
      <label for="mission_crew_size">Crew Size:</label>
      <input type="number" required class="form-control" name="mission_crew_size" placeholder="Crew Size" required>
    </div>
