...
<div class="container">
    ...
    <div class="container" style="text-align:center;">
        ...
        <h6 style="text-align:center;">click on one of the options bellow</h6>
            ...
            <a href='astronaut_select_db.php' type="button" class="btn btn-lg btn-primary">LIST ALL THE ASTRONAUTS</a>
...
<!-- It will populate the above table with the batabase content -->
    ...
    if ($result->num_rows > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td>" . $row["astronaut_id"] . "<td>" . $row["name"] . "<td>" . " " . $row["no_missions"];
      }
    }
